...
if __name__ == '__main__':
    while (y := int(input('Nth fibonacci number or -1 to exit: '))) != -1:
        # print(baretka_fib.iterative_variable_fib(y))
        # baretka_fib.iterative_field_fib(y)
        # baretka_fib.explicit_fib(y)
        # baretka_fib.recursive_fib(y)
        # y = int(input('Number of pascal triangle rows: '))
        # baretka_pascal.dynamic_variable_pascal(y)
        # baretka_pascal.dynamic_pascal(y)
        # baretka_pascal.explicit_pascal(y)
        # baretka_pascal.explicit_variable_pascal(y)
        # baretka_pascal.recursive_pascal(y)
        ...
        # print('Darts method:', baretka_pi_calculation.darts_method(y * 100000))
